...
public interface WalletController {
    ...
    @GetMapping("/{id}")
    ResponseEntity<WalletResponse> getWalletById(@Parameter(description = "ID of the wallet", required = true) @PathVariable UUID id);
    ...
    @PutMapping("/{id}")
    ResponseEntity<WalletResponse> updateWallet(@Parameter(description = "ID of the wallet", required = true) @PathVariable UUID id, @RequestBody WalletRequest request);
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<Void> deleteWallet(@Parameter(description = "ID of the wallet", required = true) @PathVariable UUID id);
}
